  ...
  return dashboardData ? (
    <div className="w-full p-4 sm:p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {/* Card 1 */}
        <div
          className="flex items-center gap-3 bg-white border rounded-2xl px-5 py-6 
      ...
      <div className="mt-10">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-md border-separate border-spacing-y-1 min-w-[600px]">
            <thead>
              <tr>
                <th className="pb-1 px-6 text-left text-gray-500 font-medium">
                  S.No
                </th>
                <th className="pb-1 px-6 text-left text-gray-500 font-medium">
                  Student name
                </th>
                <th className="pb-1 px-10 text-left text-gray-500 font-medium">
                  Course Title
                </th>
              </tr>
            </thead>
